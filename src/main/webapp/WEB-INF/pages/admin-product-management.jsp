...
<body>
    ...
    <div class="main">
        <div class="main-inner">
            <div class="topbar">
                ...
                <button class="logout" onclick="window.location.href='<%=request.getContextPath()%>/logout'">Logout</button>
            </div>

            <%
			    Integer lowStockAttr = (Integer) request.getAttribute("lowStockCount");
			    int lowStockVal = (lowStockAttr != null) ? lowStockAttr : 0;
			    Integer totalAttr = (Integer) request.getAttribute("totalItems");
			    int totalVal = (totalAttr != null) ? totalAttr : 0;
			%>
			...
			<div class="stats">
			    ...
			    <div class="card" onclick="showLowStock()" style="cursor:pointer;">
			        <p>Low Stock</p>
			        <h3 style="color:#ef4444"><%= String.format("%02d", lowStockVal) %></h3>
			    </div>
			    <div class="card">
			        <p>Quick Actions</p>
    ...
    <div id="productModal" class="modal">
	    <div class="modal-content">
	        ...
	        <form id="productForm" method="post" action="<%= request.getContextPath() %>/admin-products">
